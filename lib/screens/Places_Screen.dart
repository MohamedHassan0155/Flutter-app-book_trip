import 'package:book_trip/screens/place_details_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle:true,
        title:  Text(widget.placeName,style: TextStyle(color: Colors.black,fontSize:24,fontWeight: FontWeight.bold,fontFamily: 'flu' ),),
        elevation: 0.0,
      ),
